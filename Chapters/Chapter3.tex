...
Where $t_{ij,m} = t_0 e^{i(\frac{\pi}{2}-\theta_{ij})m} J_m(\alpha_{ij})$ and $J_m(x)$ is the \textit{m}th Bessel function. Correspondingly $\hat{T}(t) = \sum_m \hat{T}_m e^{im \omega t}$.
