...
&= \sum_{\langle i,j \rangle} \left\{ J_{ij}(t)\bs{S}_i\bs{S}_j +\bs{D}_{ij}(t)\bs{S}_i \times \bs{S}_j + \bs{S}_i\bs{\Gamma}_{ij}(t)\bs{S}_j \right\}
\end{align*}
...
\Gamma_{ij}^{\alpha \beta}(t) &= (\delta_{\alpha \beta} \bs{\Delta}_{ij}^2 - 2\Delta_{ij}^\alpha\Delta_{ij}^\beta )\mathcal{M}(\alpha_{ij}, \text{U}, \omega, t)
\end{align}
