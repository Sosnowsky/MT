...
\begin{align}
\phi_{in}(\textbf{r}) &= \frac{1}{\sqrt{M}}\sum_{\textbf{k}\in BZ} e^{-i\textbf{k}\textbf{r}_i} \psi_{n\textbf{k}}(\textbf{r}) \label{Wannier1} \\
\psi_{n\bs{k}}(\bs{r}) &= \frac{1}{\sqrt{M}} \sum_{\bs{R}} e^{i\bs{k}\bs{R}} \phi_{\bs{R}n}(\bs{r}) \label{Wannier2}
\end{align}
